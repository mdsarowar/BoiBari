...
//        return $cat;
//        $tps=SimpleProduct::where('category_id',$cat->id)->paginate(10);
//        return $tps;
        if($genral && $genral->verify_status=='1'){
            ...
            $data['authors'] =Author::where('status','1')->paginate(10);
            $data['publishers'] =Publisher::where('status','1')->paginate(10);
            $data['top_categories'] = Category::where('status','1')->orderBy('id','DESC')->paginate(10);
            $data['top_selles'] = SimpleProduct::where('status','1')->orderBy('id','DESC')->paginate(10);
            $data['latest_products'] = SimpleProduct::where('status','1')->orderBy('id','DESC')->paginate(9);
            if (!$bcs == null){
            $data['bcs_products'] = SimpleProduct::where('category_id',$bcs->id)->where('status','1')->orderBy('id','DESC')->paginate(10);
            }
            if (!$bank == null){
            $data['bank_products'] = SimpleProduct::where('category_id',$bank->id)->where('status','1')->orderBy('id','DESC')->paginate(10);
            }
            if (!$academic == null){
            $data['academic_products'] = SimpleProduct::where('category_id',$academic->id)->where('status','1')->orderBy('id','DESC')->paginate(10);
            }
