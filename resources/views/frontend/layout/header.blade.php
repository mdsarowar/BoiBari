                            ...
                            <div class="topbar-sidenav">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="menu-tab-pane" role="tabpanel" aria-labelledby="menu-tab" tabindex="0">
                                        <ul class="navbar-nav">
                                            <li class="nav-item">
                                                <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" title="{{__('Categories')}}"><i data-feather="award"></i>{{__('All Categories')}}</a>
                                                <ul class="dropdown-menu">
...
{{--                                            </li>--}}
                                            ...
                                            @else
                                            <li class="nav-item">
                                                <a class="nav-link" href="{{url('login')}}" title="Login"><i data-feather="log-out"></i>{{ __('Login') }}</a>
                                                <a class="nav-link" href="{{url('register')}}" title="Register"><i data-feather="user"></i>{{ __('Register') }}</a>
                                            </li>
                                            @endif
                    ...
                    <div class="row">
                        <ul class="navbar-nav">
                            <li class="nav-item active col-md-2">
                                <a  class="form-select " href="#" data-bs-toggle="dropdown" title="{{__('Categories')}}" >{{__('All Categories')}} </a>
                                <ul class="dropdown-menu">
                                    @foreach(App\Category::where('status','1')->orderBy('position')->paginate(10) as $key => $cat)
                                        <li>
                                            <a class="dropdown-item" href="javascript:" onclick="changeCategory({{$cat->id}},'main')" title="{{ $cat->title }}">
