                                ...
                                <form novalidate id="loginform" method="POST" class="form register-form outer-top-xs" role="form" action="{{ route('normal.login') }}">
                                    ...
                                    @else
                                        <div class="mb-3">
                                            ...
                                            <input required type="email" name="mobile" class="form-control {{ $errors->has('mobile') ? ' is-invalid' : '' }}" value="{{ old('mobile') }}" autofocus id="exampleInputmobile" aria-describedby="mobilehellp">
...
{{--                                            <label for="exampleInputEmail2" class="form-label">{{__('email')}}</label>--}}
                                      ...
                                      <strong>{{ $errors->first('password') }}</strong>
                                        ...
                                        <div class="mb-3">
                                            <label for="exampleInputPassword3" class="form-label">{{__('Create Password')}}<span class="required">*</span></label>
