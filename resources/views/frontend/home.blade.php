        ...
        <section id="customer-support" class="customer-support-main-block">
            <div class="container">
                <div class="row" style="background-color: #0a6aa1; margin-bottom: 15px">
                    <div class="col-lg-6">
                        <h3 class="section-title text-light">{{__('Top Categories')}} </h3>
                    </div>
                    <div class="col-lg-6">
    ...
    @if(count($top_selles))
        ...
        <section id="top-seller" class="feature-brand-main-block">
            <div class="container">
                <div class="row" style="background-color: #0a6aa1; margin-bottom: 15px">
                    <div class="col-lg-6">
                        <h3 class="section-title text-light">{{__('Top Seller Books')}}</h3>
                    </div>
                    <div class="col-lg-6">
                        <div class="view-all-btn">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-7">
                                                        ...
                                                        <p>By <span><a href="#" title=""
                                                                       class="store-name">{{__($featured_pro->store?$featured_pro->store->name:'')}}</a></span>
                                                        </p>
                                                    </div>
                                                    <div class="col-lg-5">
    ...
    @if(!empty($featured_products))
        ...
        <section id="feature-brand" class="feature-brand-main-block">
            <div class="container">
                <div class="row" style="background-color: #0a6aa1; margin-bottom: 15px">
                    <div class="col-lg-6">
                        <h3 class="section-title text-light">{{__('Featured Products')}}</h3>
                    </div>
                    <div class="col-lg-6">
                        <div class="view-all-btn">
                            <a href="{{route('all_product')}}" type="button" class="btn btn-primary"
            ...
            <div class="container">
                <div class="row" style="background-color: #0a6aa1">
                    <div class="col-lg-6 col-8">
                        <h3 class="section-title text-light">{{__('Latest Products')}}</h3>
                    </div>
...
{{--                                                            </li>--}}
    ...
    @if(count($bcs_products))
        <!-- BCS Books Start -->
        <section id="feature-brand" class="feature-brand-main-block">
            <div class="container">
                <div class="row" style="background-color: #0a6aa1; margin-bottom: 15px">
                    <div class="col-lg-6">
                        <h3 class="section-title text-light">{{__('BCS Books')}}</h3>
                    </div>
                    <div class="col-lg-6">
                        <div class="view-all-btn">
                            <a href="{{route('all_product',[$bcs->id,'main'])}}" type="button" class="btn btn-primary"
                               title="{{__('View All')}}">{{__('View All')}}</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div id="bcs-book-slider" class="featured-brand-slider-main-block owl-carousel owl-theme">
                            @foreach($bcs_products as $featured_pro)
                                <div class="item" data-aos="fade-right">
                                    <div class="featured-brand-block border-hover">
                                        <div class="border-hover-two">
                                            <div class="featured-product-img">
...
{{--                                                        </li>--}}
    ...
    @if(!empty($authors))
        ...
        <section id="customer-support" class="customer-support-main-block">
            <div class="container">
                <div class="row" style="background-color: #0a6aa1; margin-bottom: 15px">
                    <div class="col-lg-6">
                        <h3 class="section-title text-light">{{__('Author')}}</h3>
                    </div>
                    <div class="col-lg-6">
                        <div class="view-all-btn">
    ...
    @if(count($bank_products))
        <!-- Bank Books Start -->
        <section id="feature-brand" class="feature-brand-main-block">
            <div class="container">
                <div class="row" style="background-color: #0a6aa1; margin-bottom: 15px">
                    <div class="col-lg-6">
                        <h3 class="section-title text-light">{{__('Bank Books')}}</h3>
                    </div>
                    <div class="col-lg-6">
                        <div class="view-all-btn">
                            <a href="{{route('all_product',[$bank->id,'main'])}}" type="button" class="btn btn-primary"
                               title="{{__('View All')}}">{{__('View All')}}</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div id="bank-book-slider" class="featured-brand-slider-main-block owl-carousel owl-theme">
                            @foreach($bank_products as $featured_pro)
                                <div class="item" data-aos="fade-right">
                                    <div class="featured-brand-block border-hover">
                                        <div class="border-hover-two">
                                            <div class="featured-product-img">
...
{{--                                                        </li>--}}
    ...
    @if(!empty($academic_products))
        <!-- Academic Start -->
        <section id="feature-brand" class="feature-brand-main-block">
            <div class="container">
                <div class="row" style="background-color: #0a6aa1; margin-bottom: 15px">
                    <div class="col-lg-6">
                        <h3 class="section-title text-light">{{__('Academic Books')}}</h3>
                    </div>
                    <div class="col-lg-6">
                        <div class="view-all-btn">
                            <a href="{{route('all_product',[$academic->id,'main'])}}" type="button" class="btn btn-primary"
                               title="{{__('View All')}}">{{__('View All')}}</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div id="academic-slider" class="featured-brand-slider-main-block owl-carousel owl-theme">
                            @foreach($academic_products as $featured_pro)
                                <div class="item" data-aos="fade-right">
                                    <div class="featured-brand-block border-hover">
                                        <div class="border-hover-two">
                                            <div class="featured-product-img">
    ...
    @if(!empty($publishers))
        ...
        <section id="customer-support" class="customer-support-main-block">
            <div class="container">
                <div class="row" style="background-color: #0a6aa1; margin-bottom: 15px">
                    <div class="col-lg-6">
                        <h3 class="section-title text-light">{{__('Publisher')}}</h3>
                    </div>
                    <div class="col-lg-6">
                        <div class="view-all-btn">
