                        ...
                        <div class="checkout-login checkout-block accordion-item">
                            <div class="accordion-header">
                                <h3 class="section-title accordion-button" type="button" data-bs-toggle="collapse"
                                    ...
                                    A. <?php if(auth()->guard()->guest()): ?>
                                        <span>1</span> <?php echo e(__('Login')); ?>

                                    <?php else: ?>
                                        <?php echo e(__('Logged In')); ?>
                                        ...
                                        <div class="py-30">
                                                    ...
                                                    <div class="view-all-btn">
                                                        <a class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                                           href="#exampleModalToggle" role="button"><i
                                                                    data-feather="plus"></i><?php echo e(__('Add New Address')); ?>
                                                ...
                                                <div class="row mt-4">
                                                    <?php if(isset($addresses)): ?>
                                                        <?php $__currentLoopData = $addresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <!-- Edit Modal -->
                                                            <div class="modal fade" id="editModal<?php echo e($address->id); ?>"
                                                                    ...
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="p-2 modal-title"
                                                                                id="myModalLabel"><?php echo e(__('Edit Address')); ?></h5>
                                                                            <button type="button" class="btn-close"
                                                                                    data-bs-dismiss="modal"
                                                                                    aria-label="Close"></button>
                                                                        </div>
                                                                        <div class="modal-body">
                                                                            <form action="<?php echo e(route('address.update',$address->id)); ?>"
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-lg-4 col-md-6 col-12">
                                                                                        <div class="mb-3">
                                                                                            <label class="font-weight-bold"
                                                                                                   class="font-weight-normal"
                                                                                                   for="email"><?php echo e(__('PhoneNo')); ?>
                                                                                    ...
                                                                                    <div class="col-lg-12 col-md-12 col-12">
                                                                                        <div class="mb-3">
                                                                                            <label class="font-weight-bold"
                                                                                                   class="font-weight-normal"><?php echo e(__('Address')); ?>
                                                                                            ...
                                                                                            <textarea required=""
                                                                                                      ...
                                                                                                      id="address"
                                                                                                      cols="20" rows="5"
                                                                                                      class="form-control"><?php echo e(strip_tags($address->address)); ?></textarea>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                    ...
                                                                                    <div class="mb-3">
                                                                                        <div class="form-group checkout-personal-dtl">
                                                                                            <label class="address-checkbox"><?php echo e(__('Set Default Address')); ?>
                                                                                                ...
                                                                                                <input <?php echo e($address->defaddress == 1 ? "checked" : ""); ?> type="checkbox"
                                                                                                       name="setdef">
                                                                                ...
                                                                                <div class="col-lg-12 col-md-6 col-12">
                                                                                    <button class="btn btn-primary"><i
                                                                                                data-feather="save"></i><?php echo e(__('Update')); ?>
                                                            ...
                                                            <div class="modal fade delete-modal"
                                                                 id="deletemodal<?php echo e($address->id); ?>" tabindex="-1"
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body text-center">
                                                                            ...
                                                                            <p><?php echo e(__('Do you really want to delete this address? This process cannot be undone')); ?>

                                                                                .</p>
                                                                        </div>
                                                                        <div class="modal-footer">
                                                                            <form method="post"
                                                                                  action="<?php echo e(route('address.del',$address->id)); ?>"
                                                                                  class="pull-right">
                                                    ...
                                                    <?php else: ?>
                                                        <h2><a class="cursor" data-target="#mngaddress"
                                                               data-toggle="modal"><?php echo e(__('No Address')); ?></a></h2>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                            ...
                                            <form action="<?php echo e(route('choose.address')); ?>" method="post">
                                                ...
                                                <?php if($addresses->count() == 0 ): ?>
                                                    <button type="submit" disabled class="btn btn-primary mt-3"><?php echo e(__('Deliver Heres')); ?></button>
                                                <?php else: ?>
                                                    <button type="submit" class="btn btn-primary  mt-3"><?php echo e(__('Deliver Heret')); ?></button>
                                                <?php endif; ?>
                                            </form>
                                            ...
                                            <div class="modal fade" id="exampleModalToggle" aria-hidden="true"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="p-2 modal-title"
                                                                id="myModalLabel"><?php echo e(__('Add Address')); ?></h5>
                                                            <button type="button" class="btn-close"
                                                                    data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <form action="<?php echo e(route('address.store')); ?>" role="form"
                                                                  method="POST">
                                                                <?php echo csrf_field(); ?>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-4 col-md-6 col-12">
                                                                        <div class="mb-3">
                                                                            <label class="font-weight-bold"
                                                                                   class="font-weight-normal"><?php echo e(__('Name')); ?>

                                                                                :</label>
                                                                            <input required type="text"
                                                                                   <?php if($ifadd<1): ?> value="<?php echo e(Auth::user()->name); ?>"
                                                                                   <?php else: ?> value=""
                                                                                   <?php endif; ?> placeholder="<?php echo e(__('Enter name')); ?>"
                                                                    ...
                                                                    <div class="col-lg-4 col-md-6 col-12">
                                                                        <div class="mb-3">
                                                                            <label class="font-weight-bold"
                                                                                   class="font-weight-normal"><?php echo e(__('Phone No')); ?>

                                                                                :</label>
                                                                            <input required type="text"
                                                                                   <?php if($ifadd<1): ?> value="<?php echo e(Auth::user()->mobile); ?>"
                                                                                   <?php else: ?> value="" <?php endif; ?> name="phone"
                                                                                   placeholder="<?php echo e(__('Enter phone no')); ?>"
                                                                                   class="form-control">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-12 col-md-12 col-12">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <textarea required name="address"
                                                                                      ...
                                                                                      class="form-control"><?php echo e(old('address')); ?></textarea>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-12 col-md-12 col-12">
                                                                        <button class="btn btn-primary"><i
                                                                                    data-feather="save"></i><?php echo e(__('Submit')); ?>
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="nav flex-column nav-pills me-3" id="v-pills-tab"
                                                        ...
                                                        <a class="nav-link" id="bkash_gateway-tab"
                                                           ...
                                                           aria-selected="false"><?php echo e(__('Bkash Gateway')); ?></a>
                                                        <?php if($config->paypal_enable == '1'): ?>
                                                            <a class="nav-link active" id="v-pills-paypalpaytab-tab"
                                                               ...
                                                               onclick=handlingcharge(this.id)><?php echo e(__('Pay Via Paypal')); ?></a>
                                                        <?php endif; ?>
                                                        <?php if($wallet_system == 1): ?>
                                                            <a class="nav-link" id="v-pills-wallet-tab"
                                                               ...
                                                               aria-selected="false"><?php echo e(__('Pay Via Wallet')); ?></a>
                                                        <?php endif; ?>
                                                        <?php if($config->braintree_enable == '1'): ?>
                                                            <a class="nav-link" id="v-pills-braintree-tab"
                                                               ...
                                                               aria-selected="false"><?php echo e(__('Pay Via Braintree')); ?></a>
                                                        <?php endif; ?>
                                                        <?php if($config->paystack_enable == '1'): ?>
                                                            <a class="nav-link" id="v-pills-paystack-tab"
                                                               ...
                                                               aria-selected="false"><?php echo e(__('Pay Via Paystack')); ?></a>
                                                        <?php endif; ?>
                                                        <?php if($config->instamojo_enable == '1'): ?>
                                                            <a class="nav-link" id="v-pills-instamojo-tab"
                                                               ...
                                                               aria-selected="false"><?php echo e(__('Pay Via Instamojo')); ?></a>
                                                        <?php endif; ?>
                                                        <?php if($config->stripe_enable == '1'): ?>
                                                            <a class="nav-link" id="v-pills-stripe-tab"
                                                               ...
                                                               aria-selected="false"><?php echo e(__('Pay Via Stripe')); ?></a>
                                                        <?php endif; ?>
                                                        <?php if($config->payu_enable == '1'): ?>
                                                            <a class="nav-link" id="v-pills-payu-tab"
                                                               ...
                                                               aria-selected="false"><?php echo e(__('Pay Via PayUBiz / Money')); ?></a>
                                                        <?php endif; ?>
                                                        <?php if($config->paytm_enable == '1'): ?>
                                                            <a class="nav-link" id="v-pills-paytam-tab"
                                                               ...
                                                               aria-selected="false"><?php echo e(__('Pay Via Paytam')); ?></a>
                                                        <?php endif; ?>
                                                        <?php if($config->razorpay == '1'): ?>
                                                            <a class="nav-link" id="v-pills-razorpay-tab"
                                                               ...
                                                               aria-selected="false"><?php echo e(__('Pay Via Razorpay')); ?></a>
                                                        <?php endif; ?>
                                                        <?php if($config->payhere_enable == '1'): ?>
                                                            <a class="nav-link" id="v-pills-payhere-tab"
                                                               ...
                                                               aria-selected="false"><?php echo e(__('Pay Via Payhere')); ?></a>
                                                        <?php endif; ?>
                                                        <?php if($config->cashfree_enable == '1'): ?>
                                                            <a class="nav-link" id="v-pills-cashfree-tab"
                                                               ...
                                                               aria-selected="false"><?php echo e(__('Pay Via Cashfree')); ?></a>
                                                        <?php endif; ?>
                                                        <?php if($config->omise_enable == '1'): ?>
                                                            <a class="nav-link" id="v-pills-omise-tab"
                                                               ...
                                                               aria-selected="false"><?php echo e(__('Pay Via Omise')); ?></a>
                                                        <?php endif; ?>
                                                        <?php if($config->rave_enable == '1'): ?>
                                                            <a class="nav-link" id="v-pills-rave-tab"
                                                               ...
                                                               aria-selected="false"><?php echo e(__('Pay Via Rave')); ?></a>
                                                        <?php endif; ?>
                                                        <?php if($config->moli_enable == '1'): ?>
                                                            <a class="nav-link" id="v-pills-moli-tab"
                                                               ...
                                                               aria-selected="false"><?php echo e(__('Pay Via Mollie')); ?></a>
                                                        <?php endif; ?>
                                                        <?php if($config->skrill_enable == '1'): ?>
                                                            <a class="nav-link" id="v-pills-skrill-tab"
                                                               ...
                                                               aria-selected="false"><?php echo e(__('Pay Via Skrill')); ?></a>
                                                        <?php endif; ?>
                                                        <?php if($config->sslcommerze_enable == '1'): ?>
                                                            <a class="nav-link" id="v-pills-sslcommerze-tab"
                                                               ...
                                                               aria-selected="false"><?php echo e(__('Pay Via SSlCommerz')); ?></a>
                                                        ...
                                                        <?php if($config->enable_amarpay == '1'): ?>
                                                            <a class="nav-link" id="v-pills-amarpay-tab"
                                                               ...
                                                               aria-selected="false"><?php echo e(__('Pay Via AAMARPAY')); ?></a>
                                                        <?php endif; ?>
                                                        <?php if($config->iyzico_enable == '1'): ?>
                                                            <a class="nav-link" id="v-pills-iyzico-tab"
                                                               ...
                                                               aria-selected="false"><?php echo e(__('Pay Via Iyzcio')); ?></a>
                                                        <?php endif; ?>
                                                        ...
                                                        <?php $__currentLoopData = App\ManualPaymentMethod::where('status','1')->get();; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <a class="nav-link" href="#manualpaytab<?php echo e($item->id); ?>"
                                                               data-toggle="tab"><?php echo e(ucfirst($item->payment_name)); ?></a>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                                                        <?php if(env('BANK_TRANSFER') == 1): ?>
                                                            <a class="nav-link" href="#btpaytab"
                                                               data-toggle="tab"><?php echo e(__('Bank Tranfer')); ?></a>
                                                        <?php endif; ?>

                                                        <?php if(env('COD_ENABLE') == 1): ?>
                                                            <a class="nav-link" href="#codpaytab"
                                                               data-toggle="tab"><?php echo e(__('Pay On Delivery')); ?></a>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="tab-content" id="v-pills-tabContent">
                                                            ...
                                                            <?php if($checkoutsetting_check->checkout_currency == 1): ?>
                                                                <div class="tab-pane fade show active"
                                                                    ...
                                                                    <?php if(isset($listcheckOutCurrency->payment_method) && strstr($listcheckOutCurrency->payment_method,'paypal')): ?>
                                                                        ...
                                                                        <form action="<?php echo e(route('processTopayment')); ?>"
                                                                              method="POST">
                                                                            ...
                                                                            <input type="hidden" name="actualtotal"
                                                                                   value="<?php echo e($un_sec); ?>">
                                                                            <input type="hidden" name="payment_method"
                                                                                   value="<?php echo e(__("Paypal")); ?>">
                                                                            <input type="hidden" name="actualtotal"
                                                                                   value="<?php echo e($un_sec); ?>">
                                                                            <button type="submit"
                                                                        ...
                                                                        <p class="text-muted"><i class="fa fa-lock"></i>
                                                                            <?php echo e(__('Your transcation is secured with Paypal 128 bit encryption')); ?>
                                                                    ...
                                                                    <?php else: ?>
                                                                        <h4><?php echo e(__('Paypal')); ?> <?php echo e(__('Check Not Available')); ?>
                                                                            ...
                                                                            <b><?php echo e(session()->get('currency')['id']); ?></b>.
                                                                        </h4>
                                                                    <?php endif; ?>
                                                                </div>
                                                            <?php else: ?>
                                                                <div class="tab-pane fade show active"
                                                                    ...
                                                                    <p class="text-muted"><i
                                                                                class="fa fa-lock"></i><?php echo e(__('Your transcation is secured with Paypal 128 bit encryption')); ?>
                                                                        ...
                                                                        <?php if(isset($listcheckOutCurrency->payment_method) && strstr($listcheckOutCurrency->payment_method,'wallet')): ?>
                                                                            <?php if(Auth::user()->wallet->status == 1): ?>
                                                                                ...
                                                                                <?php if(pre_order_disable() == false): ?>
                                                                                    ...
                                                                                    <?php if(round(Auth::user()->wallet->balance*1) >= sprintf("%.2f",Crypt::decrypt($secure_amount))): ?>
                                                                                        <h3><?php echo e(__('Pay')); ?> <i
                                                                                                    class="<?php echo e(session()->get('currency')['value']); ?>"></i>
                                                                                        ...
                                                                                        <form action="<?php echo e(route('checkout.with.wallet')); ?>"
                                                                                              method="POST">
                                                                                            <?php echo csrf_field(); ?>
                                                                                            <input type="hidden"
                                                                                                   name="actualtotal"
                                                                                            ...
                                                                                            <input class="w3-input w3-border total_secure_amount"
                                                                                                   ...
                                                                                                   name="amount"
                                                                                                   value="<?php echo e($secure_amount); ?>">
                                                                                            <button title="<?php echo e(__('Pay')); ?> <?php echo e(__('via')); ?> <?php echo e(__('Wallet')); ?>"
                                                                                                    type="submit"
                                                                                                    class="btn btn-primary">
                                                                                                <i class="fa fa-folder-o"
                                                                                                   aria-hidden="true"></i> <?php echo e(__('Pay')); ?>
                                                                                    ...
                                                                                    <?php else: ?>
                                                                                        <h4><?php echo e(__('notenoughpoint')); ?>
                                                                                            ...
                                                                                            <hr>
                                                                                            <a title="Your Wallet"
                                                                                               href="<?php echo e(route('user.wallet.show')); ?>">My
                                                                                                Wallet</a></h4>
                                                                                    <?php endif; ?>
                                                                        ...
                                                                        <?php if(pre_order_disable() == false): ?>
                                                                            ...
                                                                            <a href="javascript:void(0);"
                                                                               class="payment-btn bt-btn btn btn-md btn-primary"><i
                                                                                        class="fa fa-credit-card"></i> <?php echo e(__('Pay via Card / Paypal')); ?>

                                                                            </a>
                                                                            <form method="POST" id="bt-form"
                                                                                  action="<?php echo e(route('pay.bt')); ?>">
                                                                                <?php echo e(csrf_field()); ?>
                                                                            ...
                                                                            <p class="text-muted"><i
                                                                                        class="fa fa-lock"></i>
                                                                                <?php echo e(__('Your transcation is secured with Braintree Payments')); ?>
                                                                    ...
                                                                    <?php if(pre_order_disable() == false): ?>
                                                                        ...
                                                                        <form method="POST" id="bt-form"
                                                                            ...
                                                                            <button class="payment-final-bt d-none btn btn-md btn-primary"
                                                                                ...
                                                                                Pay
                                                                                <i class="<?php echo e(session()->get('currency')['value']); ?>"></i>
                                                                                <?php echo e(sprintf("%.2f",Crypt::decrypt($secure_amount),2)); ?>
                                                                        ...
                                                                        <hr>
                                                                        <p class="text-muted"><i
                                                                                    class="fa fa-lock"></i> <?php echo e(__('Your transcation is secured with Braintree Payments.')); ?>
                                                                ...
                                                                <?php if($checkoutsetting_check->checkout_currency == 1): ?>
                                                                    ...
                                                                    <?php if(pre_order_disable() == false): ?>
                                                                        <?php if(isset($listcheckOutCurrency->payment_method) && strstr($listcheckOutCurrency->payment_method,'paystack')): ?>
                                                                            ...
                                                                            <form method="POST"
                                                                                  action="<?php echo e(route('pay.via.paystack')); ?>"
                                                                                ...
                                                                                <input type="hidden" name="currency"
                                                                                       value="<?php echo e(session()->get('currency')['id']); ?>">
                                                                                ...
                                                                                <button class="btn btn-success btn-md"
                                                                                        type="submit"
                                                                                        value="Pay Now!"> <?php echo e(__('Pay')); ?>
                                                                            ...
                                                                            <hr>
                                                                            <p class="text-muted"><i
                                                                                        class="fa fa-lock"></i> <?php echo e(__('Your transcation is secured with Paystack Payments')); ?>
                                                                    ...
                                                                    <?php if(pre_order_disable() == false): ?>
                                                                        ...
                                                                        <form method="POST"
                                                                            ...
                                                                            <input type="hidden"
                                                                                   ...
                                                                                   name="amount"
                                                                                   value="<?php echo e(sprintf("%.2f",(Crypt::decrypt($secure_amount))*100)); ?>"> 
                                                                            <input type="hidden" name="quantity"
                                                                                   value="1">
                                                                            <input type="hidden" name="currency"
                                                                                   value="<?php echo e(session()->get('currency')['id']); ?>">
                                                        ...
                                                        <?php if($config->instamojo_enable == '1'): ?>
                                                            <div class="tab-pane fade" id="v-pills-instamojo"
                                                                    ...
                                                                    <?php if(isset($listcheckOutCurrency->payment_method) && strstr($listcheckOutCurrency->payment_method,'instamojo')): ?>
                                                                        ...
                                                                        <form action="<?php echo e(route('processTopayment')); ?>"
                                                                            ...
                                                                            <input type="hidden" name="actualtotal"
                                                                                   value="<?php echo e($un_sec); ?>">
                                                                            <input type="hidden" name="payment_method"
                                                                                   value="<?php echo e(__("Instamojo")); ?>">

                                                                            <button type="submit"
                                                                                    class="insta-buy-now-button">
                                                                                <span><?php echo e(__('Express Checkout with')); ?> <img
                                                                                            src="<?php echo e(url('images/download.png')); ?>"
                                                                                            alt="instamojo"
                                                                                            title="<?php echo e(__('Pay with Instamojo')); ?>"></span>
                                                                            </button>
                                                                        </form>
                                                                    <?php else: ?>
                                                                ...
                                                                <?php else: ?>
                                                                    ...
                                                                    <hr>
                                                                    <p class="text-muted"><i
                                                                                class="fa fa-lock"></i><?php echo e(__('Your transcation is secured with Instamojo Payment protection')); ?>
                                                        ...
                                                        <?php if($config->stripe_enable == '1'): ?>
                                                            <div class="tab-pane fade" id="v-pills-stripe"
                                                                ...
                                                                <?php if($checkoutsetting_check->checkout_currency == 1): ?>
                                                                        ...
                                                                        <?php if(pre_order_disable() == false): ?>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-lg-7 col-md-7">
                                                                                    ...
                                                                                    <br>
                                                                                    <p class="text-muted"><i
                                                                                                class="fa fa-lock"></i><?php echo e(__('Secured Transcation Powered By Stripe Payments')); ?>
                                                                                ...
                                                                                <div class="col-lg-5 col-md-5">
                                                                                    <div class="form-container active">
                                                                                        <form method="POST"
                                                                                              action="<?php echo e(route('paytostripe')); ?>"
                                                                                              id="credit-card">
                                                                                            <?php echo csrf_field(); ?>
                                                                                            <input type="hidden"
                                                                                                   name="actualtotal"
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                <button title="<?php echo e(__('Click to complete your payment !')); ?>"
                                                                                                        type="submit"
                                                                                                        class="btn btn-primary btn-lg btn-block"
                                                                                                        id="confirm-purchase"><?php echo e(__('Pay')); ?>
                                                                    ...
                                                                    <?php else: ?>
                                                                        <h4><?php echo e(__('Stripe Card')); ?> <?php echo e(__('Not Available')); ?>
                                                                    ...
                                                                    <?php if(pre_order_disable() == false): ?>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-lg-7 col-md-7">
                                                                                ...
                                                                                <p class="text-muted"><i
                                                                                            class="fa fa-lock"></i>
                                                                                    <?php echo e(__('Secured Card Transcations Powered By Stripe Payments')); ?>
                                                                            ...
                                                                            <div class="col-lg-5 col-md-5">
                                                                                <h3><?php echo e(__('Pay')); ?> <i
                                                                                            class="<?php echo e(session()->get('currency')['value']); ?>"></i>
                                                                                    <?php echo e(price_format(Crypt::decrypt($secure_amount),2)); ?>
                                                        ...
                                                        <?php if($config->payu_enable == '1'): ?>
                                                            <div class="tab-pane fade" id="v-pills-payu" role="tabpanel"
                                                                ...
                                                                <?php if($checkoutsetting_check->checkout_currency == 1): ?>
                                                                    <?php if(isset($listcheckOutCurrency->payment_method) && strstr($listcheckOutCurrency->payment_method,'payu')): ?>
                                                                        ...
                                                                        <?php if(pre_order_disable() == false): ?>
                                                                            ...
                                                                            <form action="<?php echo e(route('processTopayment')); ?>"
                                                                                ...
                                                                                <input type="hidden"
                                                                                       name="payment_method"
                                                                                       value="<?php echo e(__("Payu")); ?>">
                                                                                <input type="hidden" name="actualtotal"
                                                                                       value="<?php echo e($un_sec); ?>">
                                                                                <button type="submit"
                                                                                        class="payu-buy-now-button">
                                                                                <span><?php echo e(__('Express checkout with')); ?> <img
                                                                                            src="<?php echo e(url('images/payu.png')); ?>"
                                                                                            alt="payulogo"
                                                                            ...
                                                                            <hr>
                                                                            <p class="text-muted"><i
                                                                                        class="fa fa-lock"></i> <?php echo e(__('Secured Transcation Powered By PayU Payments')); ?>
                                                                    ...
                                                                    <?php else: ?>
                                                                        <h4><?php echo e(__('Payu Money')); ?> <?php echo e(__('Not Available')); ?>
                                                                    ...
                                                                    <?php if(isset($listcheckOutCurrency->payment_method) && strstr($listcheckOutCurrency->payment_method,'Paytm')): ?>
                                                                        ...
                                                                        <form action="<?php echo e(route('processTopayment')); ?>"
                                                                            ...
                                                                            <input type="hidden" name="actualtotal"
                                                                                   value="<?php echo e($un_sec); ?>">
                                                                            <input type="hidden" name="payment_method"
                                                                                   value="<?php echo e(__("Paytm")); ?>">
                                                                            <input type="hidden" name="actualtotal"
                                                                                   value="<?php echo e($un_sec); ?>">
                                                                            <button type="submit"
                                                                                    class="paytm-buy-now-button">
                                                                                <span>Express checkout with <img
                                                                                            src="<?php echo e(url('images/paywithpaytm.jpg')); ?>"
                                                                                            title="Pay with Paytm"></span>
                                                                            </button>
                                                                        </form>
                                                                        <hr>
                                                                        <p class="text-muted"><i class="fa fa-lock"></i>
                                                                            <?php echo e(__('Secured Transcation Powered By Paytm Payments')); ?>

                                                                        </p>

                                                                    <?php else: ?>
                                                                        <h4><?php echo e(__('Paytm')); ?> <?php echo e(__('Not Available')); ?>
                                                                ...
                                                                <?php else: ?>
                                                                    ...
                                                                    <form action="<?php echo e(route('processTopayment')); ?>"
                                                                        ...
                                                                        <button type="submit"
                                                                            ...
                                                                            <span><?php echo e(__('Express checkout with')); ?> <img
                                                                                        src="<?php echo e(url('images/paywithpaytm.jpg')); ?>"
                                                                                        title="<?php echo e(__('Pay with Paytm')); ?>"></span>
                                                                        </button>
                                                                    </form>
                                                                    <hr>
                                                                    <p class="text-muted"><i
                                                                                class="fa fa-lock"></i> <?php echo e(__('Secured Transcation Powered By Paytm Payments')); ?>
                                                        ...
                                                        <?php if($config->razorpay == '1'): ?>
                                                            <div class="tab-pane fade" id="v-pills-razorpay"
                                                                ...
                                                                <?php if($checkoutsetting_check->checkout_currency == 1): ?>
                                                                    ...
                                                                    <?php else: ?>
                                                                        <h4><?php echo e(__('RazorPay')); ?> <?php echo e(__('Not Available')); ?>
                                                                ...
                                                                <?php else: ?>
                                                                    ...
                                                                    <?php if(pre_order_disable() == false): ?>
                                                                        <form id="rpayform" action="<?php echo e(route('rpay')); ?>"
                                                                              method="POST">
                                                                            <?php
                                                                                $order = uniqid();
                                                                                Session::put('order_id',$order);
                                                                            ...
                                                                            <script src="https://checkout.razorpay.com/v1/checkout.js"
                                                                                    data-key="<?php echo e(env('RAZOR_PAY_KEY')); ?>"
                                                                                    data-amount="<?php echo e((round(Crypt::decrypt($secure_amount),2))*100); ?>"
                                                                                    data-buttontext="Pay <?php echo e(price_format(Crypt::decrypt($secure_amount))); ?> INR"
                                                                                    data-name="<?php echo e($title); ?>"
                                                                                    data-description="Payment For Order <?php echo e(Session::get('order_id')); ?>"
                                                                                    data-image="<?php echo e(url('images/genral/'.$front_logo)); ?>"
                                                                                    data-prefill.name="<?php echo e($address->name); ?>"
                                                        ...
                                                        <?php if($config->payhere_enable == '1'): ?>
                                                            <div class="tab-pane fade" id="v-pills-payhere"
                                                                ...
                                                                <?php if($checkoutsetting_check->checkout_currency == 1): ?>
                                                                        ...
                                                                        <?php if(pre_order_disable() == false): ?>
                                                                            ...
                                                                            <form method="post"
                                                                                ...
                                                                                <input type="hidden" name="return_url"
                                                                                       value="<?php echo e(url('/payhere/callback')); ?>">
                                                                                <input type="hidden" name="cancel_url"
                                                                                       value="<?php echo e(url('/checkout')); ?>">
                                                                                <input type="hidden" name="notify_url"
                                                                                       value="<?php echo e(url('/notify/payhere')); ?>">
                                                                                <input type="hidden" name="order_id"
                                                                                       value="<?php echo e($payhere_order_id); ?>">
                                                                                <input type="hidden" name="items"
                                                                                       value="Payment For Order <?php echo e($payhere_order_id); ?>">
                                                                                <input type="hidden" name="currency"
                                                                                       value="<?php echo e(session()->get('currency')['id']); ?>">
                                                                                <input type="hidden" name="amount"
                                                                                       class="total_secure_amount"
                                                                                ...
                                                                                <input type="hidden" name="city"
                                                                                       value="<?php echo e($address->getcity['name'] ?? ''); ?>">
                                                                                <input type="hidden" name="country"
                                                                                       value="<?php echo e($address->getCountry['nicename']); ?>">
                                                                                <button type="submit"
                                                                                    ...
                                                                                    <span> <i class="<?php echo e(session()->get('currency')['value']); ?>"></i>
                                                                                        <?php echo e(sprintf("%.2f",Crypt::decrypt($secure_amount),2)); ?> <img
                                                                                                src="<?php echo e(url('images/payhere.png')); ?>"
                                                                                                alt="payherelogo"
                                                                    ...
                                                                    <?php else: ?>
                                                                        <h4><?php echo e(__('Payhere')); ?> <?php echo e(__('Not Available')); ?>
                                                                ...
                                                                <?php else: ?>
                                                                    ...
                                                                    <?php if(pre_order_disable() == false): ?>
                                                                        ...
                                                                        <form method="post"
                                                                            ...
                                                                            <input type="hidden" name="amount"
                                                                                   class="total_secure_amount"
                                                                                   value="<?php echo e(Crypt::decrypt($secure_amount)); ?>">
                                                                            <input type="hidden" name="first_name"
                                                                                   value="<?php echo e(Auth::user()->name); ?>">
                                                                            <input type="hidden" name="last_name"
                                                                                   value="<?php echo e(Auth::user()->name); ?>">
                                                                        ...
                                                                        <hr>
                                                                        <p class="text-muted"><i class="fa fa-lock"></i>
                                                                            <?php echo e(__('Your transcation is secured with Payhere transcations.')); ?>
                                                        ...
                                                        <?php if($config->cashfree_enable == '1'): ?>
                                                            <div class="tab-pane fade" id="v-pills-cashfree"
                                                                    ...
                                                                    <?php if(isset($listcheckOutCurrency->payment_method) && strstr($listcheckOutCurrency->payment_method,'cashfree')): ?>
                                                                        <form action="<?php echo e(route('processTopayment')); ?>"
                                                                            ...
                                                                            <button type="submit"
                                                                                ...
                                                                                <span>Express checkout with <img
                                                                                            src="<?php echo e(url('images/cashfree.svg')); ?>"
                                                                                            alt="cashfree"
                                                                        ...
                                                                        <hr>
                                                                        <p class="text-muted"><i
                                                                                    class="fa fa-lock"></i><?php echo e(__('Your transcation is secured with Cashfree secured payments.')); ?>

                                                                            .</p>
                                                                    <?php else: ?>
                                                                        <h4><?php echo e(__('Cashfree')); ?> <?php echo e(__('Not Available')); ?>
                                                                ...
                                                                <?php else: ?>
                                                                    ...
                                                                    <hr>
                                                                    <p class="text-muted"><i
                                                                                class="fa fa-lock"></i> <?php echo e(__('Your transcation is secured with Cashfree transcations.')); ?>
                                                            ...
                                                            <div class="tab-pane fade" id="v-pills-omise"
                                                                    ...
                                                                    <?php if(isset($listcheckOutCurrency->payment_method) && strstr($listcheckOutCurrency->payment_method,'omise')): ?>
                                                                        <?php if(pre_order_disable() == false): ?>
                                                                            <form id="checkoutForm" method="POST"
                                                                                  action="<?php echo e(route('pay.via.omise')); ?>">
                                                                                <?php echo csrf_field(); ?>
                                                                                <input type="hidden" name="actualtotal"
                                                                                       value="<?php echo e($un_sec); ?>">
                                                                                <input type="hidden" name="amount"
                                                                            ...
                                                                            <hr>
                                                                            <p class="text-muted"><i
                                                                                        class="fa fa-lock"></i> <?php echo e(__('Your transcation is secured with Omise secured payments.')); ?>
                                                                        ...
                                                                        <?php endif; ?>
                                                                    <?php else: ?>
                                                                        <h4><?php echo e(__('Omise')); ?> <?php echo e(__('Not Available')); ?>
                                                                ...
                                                                <?php else: ?>
                                                                    ...
                                                                    <?php if(pre_order_disable() == false): ?>
                                                                        ...
                                                                        <hr>
                                                                        <p class="text-muted"><i
                                                                                    class="fa fa-lock"></i> <?php echo e(__('Your transcation is secured with Omise transcations.')); ?>
                                                            ...
                                                            <div class="tab-pane fade" id="v-pills-rave" role="tabpanel"
                                                                ...
                                                                <?php if($checkoutsetting_check->checkout_currency == 1): ?>
                                                                    ...
                                                                    <?php if(isset($listcheckOutCurrency->payment_method) && strstr($listcheckOutCurrency->payment_method,'rave')): ?>
                                                                        ...
                                                                        <?php if(pre_order_disable() == false): ?>
                                                                            ...
                                                                            <form method="POST"
                                                                                  action="<?php echo e(route('rave.pay')); ?>"
                                                                                  id="paymentForm">
                                                                                <?php echo csrf_field(); ?>
                                                                                <input type="hidden" name="actualtotal"
                                                                                       value="<?php echo e($un_sec); ?>">
                                                                                ...
                                                                                <input type="hidden" name="description"
                                                                                       value="Payment for order <?php echo e($rave_order_id); ?>"/>
                                                                                <input type="hidden" name="country"
                                                                                       value="NG"/>
                                                                                <input type="hidden" name="currency"
                                                                                       value="<?php echo e(session()->get('currency')['id']); ?>"/>
                                                                                ...
                                                                                <input type="submit"
                                                                                       ...
                                                                                       value="Pay <?php echo e(price_format(Crypt::decrypt($secure_amount))); ?>"/>
                                                                            </form>

                                                                            <hr>
                                                                            <p class="text-muted"><i
                                                                                        class="fa fa-lock"></i> <?php echo e(__('Your transcation is secured with Rave secured payments.')); ?>
                                                                    ...
                                                                    <?php else: ?>
                                                                        ...
                                                                        <h4><?php echo e(__('Rave')); ?> <?php echo e(__('Not Available')); ?>
                                                                ...
                                                                <?php else: ?>
                                                                    ...
                                                                    <?php if(pre_order_disable() == false): ?>
                                                                        ...
                                                                        <hr>
                                                                        <p class="text-muted"><i
                                                                                    class="fa fa-lock"></i> <?php echo e(__('Your transcation is secured with Rave transcations.')); ?>
                                                                ...
                                                                <?php if($checkoutsetting_check->checkout_currency == 1): ?>
                                                                    ...
                                                                    <?php if(isset($listcheckOutCurrency->payment_method) && strstr($listcheckOutCurrency->payment_method,'mollie')): ?>
                                                                        ...
                                                                        <?php if(pre_order_disable() == false): ?>
                                                                            ...
                                                                            <form action="<?php echo e(route('mollie.pay')); ?>"
                                                                                ...
                                                                                <button type="submit"
                                                                                    ...
                                                                                    <span><?php echo e(__('Express checkout with')); ?> <img
                                                                                                src="<?php echo e(url('images/moli.png')); ?>"
                                                                                                alt="mollielogo"
                                                                                                title="<?php echo e(__('Pay with Mollie')); ?>"></span>
                                                                                </button>
                                                                            </form>

                                                                            <hr>
                                                                            <p class="text-muted"><i
                                                                                        class="fa fa-lock"></i><?php echo e(__('Your transcation is secured with Mollie secured payments.')); ?>
                                                                        ...
                                                                        <?php endif; ?>
                                                                    <?php else: ?>
                                                                        <h4><?php echo e(__('Mollie')); ?> <?php echo e(__('Not Available')); ?>
                                                                ...
                                                                <?php if($checkoutsetting_check->checkout_currency == 1): ?>
                                                                    ...
                                                                    <?php if(isset($listcheckOutCurrency->payment_method) && strstr($listcheckOutCurrency->payment_method,'skrill')): ?>
                                                                        ...
                                                                        <?php if(pre_order_disable() == false): ?>
                                                                            ...
                                                                            <form action="<?php echo e(route('skrill.pay')); ?>"
                                                                                  method="POST" autocomplete="off">
                                                                                <?php echo csrf_field(); ?>
                                                                                <input type="hidden" name="actualtotal"
                                                                                       value="<?php echo e($un_sec); ?>">
                                                                                ...
                                                                                <button type="submit"
                                                                                    ...
                                                                                    <span><?php echo e(__('Express checkout with')); ?> <img
                                                                                                src="<?php echo e(url('images/skrill.png')); ?>"
                                                                                                alt="skrill_logo"
                                                                                                title="<?php echo e(__('Pay with Skrill')); ?>"></span>
                                                                                </button>
                                                                            </form>
                                                                            <hr>
                                                                            <p class="text-muted"><i
                                                                                        class="fa fa-lock"></i> <?php echo e(__('Your transcation is secured with Skrill secured payments.')); ?>
                                                                        ...
                                                                        <?php endif; ?>
                                                                    <?php else: ?>
                                                                        <h4><?php echo e(__('Skrill')); ?> <?php echo e(__('Not Available')); ?>
                                                        ...
                                                        <?php endif; ?>
                                                            ...
                                                            <div class="tab-pane fade" id="bkash_sslcommerze"
                                                                ...
                                                                <?php else: ?>
                                                                    <h3><?php echo e(__('Pay')); ?> <i
                                                                                class="<?php echo e(session()->get('currency')['value']); ?>"></i> <?php echo e(Crypt::decrypt($secure_amount)); ?>

                                                                    </h3>
                                                                    <hr>
                                                                    <?php if(pre_order_disable() == false): ?>
                                                                        <form action="<?php echo e(route('bkash-create-payment')); ?>"
                                                                              method="get">
                                                                            <?php echo csrf_field(); ?>
                                                                            <input type="hidden" name="actualtotal"
                                                                                   value="<?php echo e($un_sec); ?>">
                                                            ...
                                                            <div class="tab-pane fade" id="v-pills-sslcommerze"
                                                                ...
                                                                <?php if($checkoutsetting_check->checkout_currency == 1): ?>
                                                                    <?php if(isset($listcheckOutCurrency->payment_method) && strstr($listcheckOutCurrency->payment_method,'sslcommerze')): ?>
                                                                        ...
                                                                        <hr>
                                                                        <?php if(pre_order_disable() == false): ?>
                                                                            <form action="<?php echo e(route('payvia.sslcommerze')); ?>"
                                                                                  method="POST">
                                                                                <?php echo csrf_field(); ?>
                                                                                <input type="hidden" name="actualtotal"
                                                                                       value="<?php echo e($un_sec); ?>">
                                                                        ...
                                                                        <?php endif; ?>
                                                                    <?php else: ?>
                                                                        <h4><?php echo e(__('SSLCommerz')); ?> <?php echo e(__('Not Available')); ?>
                                                        ...
                                                        <?php if($config->enable_amarpay == '1'): ?>
                                                            <div class="tab-pane fade" id="v-pills-amarpay"
                                                                ...
                                                                <?php if($checkoutsetting_check->checkout_currency == 1): ?>
                                                                    ...
                                                                    <?php else: ?>
                                                                        <h4><?php echo e(__('AAMARPAY')); ?> <?php echo e(__('Not Available')); ?>
                                                                ...
                                                                <?php if($checkoutsetting_check->checkout_currency == 1): ?>
                                                                    <?php if(isset($listcheckOutCurrency->payment_method) && strstr($listcheckOutCurrency->payment_method,'iyzico')): ?>
                                                                        ...
                                                                        <?php if(pre_order_disable() == false): ?>
                                                                            ...
                                                                            <form action="<?php echo e(route('iyzcio.pay')); ?>"
                                                                                  method="POST" autocomplete="off">
                                                                                <?php echo csrf_field(); ?>
                                                                                <div class="row">
                                                                                ...
                                                                                <input type="hidden" name="state"
                                                                                       value="<?php echo e($address->getstate['name']); ?>"/>
                                                                                <input type="hidden" name="country"
                                                                                       value="<?php echo e($address->getCountry['name']); ?>"/>
                                                                                <input type="hidden" name="pincode"
                                                                                       value="<?php echo e($address->pin_code); ?>"/>
                                                                                <input type="hidden" name="language"
                                                                                       value="<?php echo e(app()->getLocale()); ?>"/>
                                                                                <button class="btn btn-primary btn-md"
                                                                                        title="checkout"
                                                                    ...
                                                                    <?php else: ?>
                                                                        <h4><?php echo e(__('Iyzico')); ?> <?php echo e(__('Not Available')); ?>
                                                        ...
                                                        <?php $__currentLoopData = App\ManualPaymentMethod::where('status','1')->get();; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <div class="tab-pane manualpaytab"
                                                                 id="manualpaytab<?php echo e($item->id); ?>">
                                                                ...
                                                                <?php if($checkoutsetting_check->checkout_currency == 1): ?>
                                                                    <?php if(isset($listcheckOutCurrency->payment_method) && strstr($listcheckOutCurrency->payment_method,$item->payment_name)): ?>
                                                                        ...
                                                                        <?php if(pre_order_disable() == false): ?>
                                                                            ...
                                                                            <form action="<?php echo e(route('manualpay.checkout',['token' => $token, 'payvia' => $item->payment_name])); ?>"
                                                                                  method="POST"
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input required
                                                                                           ...
                                                                                           type="file"
                                                                                           class="<?php $__errorArgs = ['purchase_proof'];
...
unset($__errorArgs, $__bag); ?> form-control mt-3 mb-3"
                                                                                           name="purchase_proof"/>
...
unset($__errorArgs, $__bag); ?>
                                                                                ...
                                                                                <button type="submit"
                                                                                    ...
                                                                                    <span><?php echo e($item->payment_name); ?></span>
                                                                                ...
                                                                                <div class="card card-1 mt-3">
                                                                                    <div class="text-center card-body">
                                                                                        ...
                                                                                        <img width="300px"
                                                                                             height="300px"
                                                                                             class="img-fluid"
                                                                                             src="<?php echo e(url('images/manual_payment/'.$item->thumbnail)); ?>"
                                                                                             alt="<?php echo e($item->thumbnail); ?>">
                                                                                    </div>
                                                                                </div>
                                                                    ...
                                                                    strstr($listcheckOutCurrency->payment_method,'bankTransfer')): ?>
                                                                        ...
                                                                        <?php else: ?>
                                                                            <?php if(pre_order_disable() == false): ?>
                                                                                ...
                                                                                <form action="<?php echo e(route('bank.transfer.process',str_random(25))); ?>"
                                                                                      method="POST"
                                                                                      enctype="multipart/form-data">
                                                                                    <?php echo csrf_field(); ?>
                                                                                    <input type="hidden"
...
unset($__errorArgs, $__bag); ?>
                                                                                    ...
                                                                                    <button title="<?php echo e(__('Bank Tranfer')); ?>"
                                                                                            type="submit"
                                                                                            class="cod-buy-now-button">
                                                                                        <span><?php echo e(__('Bank Tranfer')); ?></span>
                                                                                        <i class="fa fa-money"></i>
                                                                                    </button>
                                                                                </form>
                                                                                ...
                                                                                <hr>
                                                                                <p class="text-muted"><i
                                                                                            class="fa fa-money"></i> <?php echo e(__('Bank Transfer')); ?>
                                                                                ...
                                                                                <div class="card card-1 mt-3">
                                                                                    <div class="card-body">
                                                                                        ...
                                                                                        <?php if(isset($bankT)): ?>
                                                                                            <p><?php echo e(__('Account Name')); ?>

                                                                                                : <?php echo e($bankT->account); ?></p>
                                                                                            <p><?php echo e(__('A/c No')); ?>

                                                                                                : <?php echo e($bankT->account); ?></p>
                                                                                            <p><?php echo e(__('BankName')); ?>

                                                                                                : <?php echo e($bankT->bankname); ?></p>
                                                                                            <?php if($bankT->ifsc != ''): ?>
                                                                                                <p><?php echo e(__('IFSC Code')); ?>

                                                                                                    : <?php echo e($bankT->ifsc); ?></p>
                                                                                            <?php endif; ?>
                                                                                            <?php if($bankT->swift_code != ''): ?>
                                                                                                <p><?php echo e(__('SWIFT Code')); ?>

                                                                                                    : <?php echo e($bankT->swift_code); ?></p>
                                                                                            <?php endif; ?>
                                                                                        <?php else: ?>
                                                        ...
                                                        <?php if(env('COD_ENABLE') == 1): ?>
                                                                    ...
                                                                    strstr($listcheckOutCurrency->payment_method,'cashOnDelivery')): ?>
                                                                        ...
                                                                        <?php echo e(price_format(Crypt::decrypt($secure_amount))); ?>
                                                                            ...
                                                                            <?php if(pre_order_disable() == false): ?>
                                                                                ...
                                                                                <form action="<?php echo e(route('cod.process',$token)); ?>"
                                                                                      method="POST">
                                                                                    <?php echo csrf_field(); ?>
                                                                                    <input type="hidden"
                                                                                           name="actualtotal"
                                                                                    ...
                                                                                    <button title="<?php echo e(__('Poddoor')); ?>"
                                                                                            type="submit"
                                                                                            class="cod-buy-now-button">
                                                                                        <span><?php echo e(__('Pod')); ?></span> <i
                                                                                                class="fa fa-money"></i>
                                                                                    </button>
                                                                                </form>
                                                                                <hr>
                                                                                <p class="text-muted"><i
                                                                                            class="fa fa-money"></i> <?php echo e(__('Poddoor')); ?>
                                                            ...
                                                            <?php else: ?>
                                                                ...
                                                                <div class="tab-pane" id="codpaytab">
                                                                    ...
                                                                    <?php if(in_array(0, $codcheck)): ?>
                                                                        <span span
                                                                              class="required"><?php echo e(__('Some Product Not Support')); ?></span>
                                                                    <?php else: ?>
                                                                        <?php
                                                                            $token = str_random(25);
                                                                        ?>
                    ...
                    <div class="cart-block">
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><i class="<?php echo e(session()->get('currency')['value']); ?>"></i> <?php echo e(price_format($ctotal)); ?></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span id="grandtotal">
                                        ...
                                        <?php else: ?>
                                            <span class="payment_amount_label">
                                                <?php echo e(price_format($ctotal)); ?>

                                                </span>

                                            <input type="hidden" id="getgrandtotal" value=" <?php echo e(price_format($ctotal)); ?>">
                                        <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("frontend.layout.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\boibari\resources\views/frontend/checkout_step3-old.blade.php ENDPATH**/ ?>