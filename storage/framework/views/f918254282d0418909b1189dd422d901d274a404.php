  ...
  <div class="modal-dialog">
      <div class="modal-content">
          ...
          <div class="modal-body">
              <form action="<?php echo e(route('address.update',$address->id)); ?>" role="form" method="POST" id="update_form">
                  <?php echo csrf_field(); ?>
                  <div class="row">
                  ...
                  <div class="col-lg-12 col-md-6 col-12">
                      <button type="submit"  class="btn btn-primary"><i data-feather="save"></i><?php echo e(__('Update')); ?></button>
                  </div>
              </form>
          </div>
      </div>
...
</html><?php /**PATH D:\xampp\htdocs\boibari\resources\views/frontend/editmodallocation.blade.php ENDPATH**/ ?>