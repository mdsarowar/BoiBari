<html>
  ...
  <body>
    ...
    <div class="col-lg-4 col-md-4">
        <div class="mb-30">
            <label for="select_state" class="form-label"><?php echo e(__('State')); ?></label>
            <select id="select_state" name="state_id" class="form-select select_state" aria-label="Default select example" required></select>
        </div>
    </div>
    <div class="col-lg-4 col-md-4">
        <div class="mb-30">
            <label for="select_country" class="form-label"><?php echo e(__('Country')); ?></label>
...
</html><?php /**PATH D:\xampp\htdocs\boibari\resources\views/frontend/location.blade.php ENDPATH**/ ?>