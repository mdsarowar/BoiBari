                                ...
                                <form novalidate id="loginform" method="POST" class="form register-form outer-top-xs" role="form" action="<?php echo e(route('normal.login')); ?>">
                                    ...
                                    <?php else: ?>
                                        <div class="mb-3">
                                            ...
                                            <input required type="email" name="mobile" class="form-control <?php echo e($errors->has('mobile') ? ' is-invalid' : ''); ?>" value="<?php echo e(old('mobile')); ?>" autofocus id="exampleInputmobile" aria-describedby="mobilehellp">
                                ...
                                <form role="form" method="POST" action="<?php echo e(route('register')); ?>" novalidate>
                                    ...
                                    <?php else: ?>
                                      ...
                                      <strong><?php echo e($errors->first('email')); ?></strong>
                                        ...
                                        <div class="mb-3">
                                            <label for="exampleInputusertype" class="form-label"><?php echo e(__('Customer Type.')); ?><span class="required">*</span></label>
                                      ...
                                      <strong><?php echo e($errors->first('password')); ?></strong>
                                        ...
                                        <div class="mb-3">
                                            <label for="exampleInputPassword3" class="form-label"><?php echo e(__('Create Password')); ?><span class="required">*</span></label>
