...
function categoryfilter(cid, sid, chid, first, last) {
  ...
  var conversion_rate = +'<?php echo e(round(2, 4)); ?>';
  var start = first;
  ...
  $.ajax({
    url: "<?php echo e(url('categoryfilter')); ?>",
    method: 'GET',
    datatype: 'html',
    data: {
      tag: tag,
...
function priceslider(cid,sid,chid) {
  ...
  $('#brand_query').on('input propertychange paste', function() {
    ...
    $.ajax({
      method: 'GET',
      url: '<?php echo e(url('filter/brand/')); ?>',
      datatype: "json",
      data: {
...
function getBrandProducts(id) {
  ...
  var lprices = +'<?php echo e($first_cat * round(2, 4)); ?>';
  lprices = lprices.toFixed(2);
  var hprices = +'<?php echo e($last_cat * round(2, 4)); ?>';
...
<?php /**PATH D:\xampp\htdocs\boibari\resources\views/frontend/filters/bottomscript.blade.php ENDPATH**/ ?>