...
var url404 = "<?php echo e(url('images/nocart.jpg')); ?>";
$(function () {
  ...
  var lprice = +'<?php echo e($first_cat * round(2, 4)); ?>';
  lprice = lprice.toFixed(2);
  var hprice = +'<?php echo e($last_cat * round(2, 4)); ?>';
  ...
  var prevCur = '<?php echo e(Session::get('previous_cur')); ?>';
  var currntCur = '<?php echo e(Session::get('current_cur')); ?>';
  var curchange = '<?php echo e(Session::get('currencyChanged')); ?>';
...
</script><?php /**PATH D:\xampp\htdocs\boibari\resources\views/frontend/filters/headscript.blade.php ENDPATH**/ ?>